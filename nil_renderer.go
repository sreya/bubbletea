...
func (n nilRenderer) requestForegroundColor()         {}
func (n nilRenderer) requestCursorColor()             {}
func (n nilRenderer) requestPrimaryDeviceAttributes() {}
func (n nilRenderer) requestEnhancedKeyboard()        {}
func (n nilRenderer) enableEnhancedKeyboard(_ int)    {}
func (n nilRenderer) disableEnhancedKeyboard()        {}
